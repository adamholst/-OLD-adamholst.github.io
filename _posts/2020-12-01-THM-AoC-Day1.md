...
## Task 6.1 - Deploy your AttackBox _(the blue "Start AttackBox" button_) and the tasks machine (_green button on this task_) if you haven't already. Once both have deployed, open FireFox on the AttackBox and copy/paste the machines IP into the browser search bar.
...
## Task 6.2 - Register for an account, and then login. What is the name of the cookie used for authentication?
...
## Task 6.3 - In what format is the value of this cookie encoded?
...
## Task 6.4 - Having decoded the cookie, what format is the data stored in?
...
## Task 6.5 - Figure out how to bypass the authentication. What is the value of Santa's cookie?
...
## Task 6.6 - Now that you are the santa user, you can re-activate the assembly line! What is the flag you're given when the line is fully active?
